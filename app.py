...
if resize_scale_input:
    st.sidebar.markdown(f"**🖼️ Resize Scale :** <br> Makes the photo/video smaller before checking. Small = faster but less clear.")
...
if scale_factor_input:
    st.sidebar.markdown(f"**📏 Scale Factor:** <br> Decides how slowly the system shrinks the picture when searching. Small = more accurate but slower.")
...
if min_neighbors_input:
    st.sidebar.markdown(f"**🔍 Min Neighbors:** <br> Says how many times a plate must appear nearby to be real. Bigger = fewer mistakes, but may miss some.")
